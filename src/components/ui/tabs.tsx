...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-full items-center justify-center rounded-md bg-muted p-0 text-muted-foreground",
      className
    )}
    {...props}
  />
